RSpec.describe 'Hashes' do
  ...
  it 'test 8' do
    ...
    # in the line below
    books = books.merge!({"Ernest Hemmingway" => "For Whom the Bell Tolls"})
    expected = {
      "John Steinbeck" => "Grapes of Wrath",
      "Harper Lee" => "To Kill a Mockingbird",
  ...
  it 'test 9' do
    ...
    books1 = {"John Steinbeck" => "Of Mice and Men"}
    books = books.merge(books1)
    expected = {
  ...
  it 'test 15' do
    ...
    ages = ages.transform_values {|v| v+1}
